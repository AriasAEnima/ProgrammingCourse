...
Por favor realiza 6 experimentos de la siguiente manera:  
...
2. Calcular la suma de los factoriales de 1 a N, es decir 
   1! + 2! + 3! + ....  n! 
    ...
    2.1 Realice este procedimiento de 1 a 1000000 (o un numero mas grande/pequeño que pueda comprobar diferencias notables) de manera secuencial. Capture una imagen los resultados en de tiempo total del procedimiento
